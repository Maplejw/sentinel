 ...
 * @since 1.5.0
 */
@Component("dynamicRuleApolloProvider")
public class DynamicRuleApolloProvider implements DynamicRuleProvider<String> {
...
//        String appId = "iggreport-gateway";
        ...
        OpenNamespaceDTO openNamespaceDTO = apolloOpenApiClient.getNamespace(appId, "PRO", "default", "application");
        String rules = openNamespaceDTO
                .getItems()
                .stream()
